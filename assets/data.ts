...
export default {
  ...
  projects: {
    SJFHOh: {
      uid: "ktUL4r76eoV1x485iXItIEo89tK2",
      project: {
        tags: [
          "マインクラフト",
          "レッドストーン",
        ...
        pid: "SJFHOhRWOtjMVIzQlQGP?submitted=true",
        description:
    ...
    eWJJgl: {
      ...
      project: {
        ...
        type: "none",
        pid: "eWJJglVJQutnry4iwMHv?submitted=true",
      },
    },
    t42w4u: {
      uid: "ktUL4r76eoV1x485iXItIEo89tK2",
      project: {
        thumbnail: "",
        title: "Markdownの教科書",
        pid: "t42w4utKR6AmKfricono?submitted=true",
        owner: "syuk0i2skk",
        type: "none",
        tags: ["Markdown"],
        id: "",
  ...
  bigrams: {
    ...
    owners: {
      ...
      こん: ["99sgyh"],
      ん部: ["99sgyh"],
      b組: ["1y6wzi", "50s8jz", "hup6lx", "2d5lgu", "ytv6yp", "vx84vf"],
      保護: ["4hjoim"],
      護者: ["4hjoim"],
      者会: ["4hjoim"],
      物理: ["d4u6fs"],
      理班: ["d4u6fs"],
      運営: ["wuhuur"],
      美術: ["u2d4u8", "7o3a1v", "zfka6h", "jeskqy"],
      化学: ["lejd3w"],
      学班: ["lejd3w"],
      "3年": ["msy1rr"],
      d組: ["t70mcl", "5py39a", "u38utw", "sohi0a", "x6xqem", "vz0hcy"],
      あー: ["4o57f4", "d0sxbx"],
      ーか: ["4o57f4"],
      かい: ["4o57f4"],
      いぶ: ["4o57f4", "s9v599"],
      ...
      歴史: ["sbcgp3"],
      史班: ["sbcgp3"],
      c組: ["ls6wa4", "to8sc7", "jt5myr", "p0z6jq", "xip46w", "4ypfcz"],
      es: ["v41x3s"],
      ss: ["v41x3s"],
      s同: ["v41x3s"],
      ...
      みあ: ["9sxnm4"],
      あ班: ["9sxnm4"],
      a組: ["fe8p7e", "gxm3qk", "lbec3f", "fl36af", "i2fod9", "kdd27p"],
      術班: ["7o3a1v", "zfka6h"],
      f組: ["2lani1", "yyr97b"],
      執行: ["09lu4q"],
      行班: ["09lu4q"],
